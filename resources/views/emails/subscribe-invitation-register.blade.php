...
@section('content')
    <table width="100%">
        ...
        <tr>
            <td style="font-size:14px;color:#333;font-weight:normal;padding-top:0px;padding-bottom:20px;text-align:left;padding-left:10px"> You have been invited to join Let’s Fl!p! As a member of the Let’s Fl!p community, you will enjoy access to a variety of {{$account_type}} and missions created by educators and students from all over the world.</td>
        </tr> 
        <tr>
