...
@section('content')
    <table width="100%">
        ...
        <tr>
            <td style="font-size:14px;color:#333;font-weight:normal;padding-top:0px;padding-bottom:20px;text-align:left;padding-left:10px"> Thank you for being a Let’s Fl!p warrior and supporting our app. We hope your user experience has been a pleasant one so far. We are inviting you to upgrade your account to enjoy more exclusive features on Let’s Fl!p! With the upgrade you will enjoy access to {{$account_type}} & Missions that is accessible only via special Classroom Keys</td>
        </tr> 
        <tr>
