...
class NotificationTransformer {
    ...
    public static function item($model){  
        ...
        if($model->type == 1 || $model->type== 2){
            ...
            $temp->text    = __('notification.TEXT.'.$model->type,[ 'type'=> $model->ClassRoom ? subsType($model->ClassRoom->type)->name : '', 'user_name_from' => $model->UserFrom->first_name.' '.$model->UserFrom->last_name , 'module_title' => $text_ ]);    
