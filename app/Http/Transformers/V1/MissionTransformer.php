...
class MissionTransformer
{
    ...
    public function item($model)
    {
        ...
        $temp = new \stdClass();
        $temp->id                   = $model->id ? $model->id : null; 
        $temp->difficulty_level     = $model->difficulty_level ? $model->difficulty_level : null; 
        $temp->title                = $model->title ? $model->title : null;
        $temp->text                 = $model->text ? $model->text : null;
        $temp->status               = $model->status ? $model->status : null;
