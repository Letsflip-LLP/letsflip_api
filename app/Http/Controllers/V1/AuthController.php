...
class AuthController extends Controller
{
        ...
        try {
            ...
            if ($user->email_verified_at == null) {
                if ($user->update(['email_verified_at' => date('Y-m-d H:i:s')])) {
                    $success = true;
                    $message = "CONGRATULATIONS! Your account has been successfully activated! The world is now your classroom";
    ...
    public function checkAppUpdate()
    {
        ...
        $data = [
            "android" => [
                "version_code" => (int) env('ANDROID_VERSION_CODE', 0),
            ...
            "ios" => [
                "version_code" => (int) env('IOS_VERSION_CODE'),
