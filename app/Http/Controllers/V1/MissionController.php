    ...
    public function addResponeMission(Request $request)
    {
        ...
        try {
            ...
            if ($mission_respone->status == 1) {
                ...
                $notif_new_respone = NotificationManager::addNewNotification(
                    $this->user_login->id,
                    $mission_detail->user_id,
                    [
            ...
            if ($request->filled("mission_id")) {
                ...
                if ($model1 == null) {
                    ...
                    if ($this->user_login->id != $mission_detail->user_id)
                        $notif_mission = NotificationManager::addNewNotification(
                            $this->user_login->id,
                            $mission_detail->user_id,
                            [
                                "mission_id"  => $request->mission_id
